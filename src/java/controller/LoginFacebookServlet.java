...
import dao.UserDAO;
import facebook.commons.RestFB;
...
public class LoginFacebookServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (code == null || code.isEmpty()) {
            ...
            User user = new User();
            user.setIDFacebook(RestFB.getUserInfo(accessToken).getId());
            user.setName(RestFB.getUserInfo(accessToken).getName());
            session.setAttribute("account", user);
//            RestFB.getUserInfo(accessToken)
