...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->           
            <!--Content admin start-->
            <form action="updatesanbong" method="post" enctype="multipart/form-data">
                <input value="${footballField.IDFootballField}" hidden="" name="fieldID">
                <label for="fieldName" class="form-label">Tên sân:</label>
                <input type="text" class="form-control"id="fieldName" name="fieldName" value="${footballField.name}" >

                <br>

                <label for="fieldType" class="form-label">Loại sân:</label>
                <input type="number" class="form-control" id="fieldType" name="fieldType" value="${footballField.typeofFootballField}" >

                <br>

                <label for="fieldPrice" class="form-label">Giá tiền (VNĐ):</label>
                <input class="form-control" type="number" id="fieldPrice" name="fieldPrice" value="${footballField.price}" >
